...
/**
 * Measures the end-to-end effect of never indexing high-cardinality request metadata.
 *
...
public class NeverIndexHighCardinalityBenchmark {
  ...
  private static final Collection<Metadata.Key<?>> HIGH_CARDINALITY_KEYS =
      Arrays.<Metadata.Key<?>>asList(
          REQUEST_ID_KEY,
          CLOUD_TRACE_ID_KEY,
          REQUEST_CONTEXT_KEY,
          CORRELATION_ID_KEY,
  ...
  public void setUp() throws Exception {
    ...
    if (headerPolicy == HeaderPolicy.NEVER_INDEX_HIGH_CARDINALITY) {
      channelBuilder.neverIndexMetadataKeys(HIGH_CARDINALITY_KEYS);
    }
