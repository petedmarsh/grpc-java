...
/** Reports CPU and modeled outbound bytes for the public-metadata HPACK benchmark. */
public final class PublicMetadataHpackProfiler implements InternalProfiler {
  private final com.sun.management.OperatingSystemMXBean operatingSystem;
  private long cpuTimeBefore;
  private long outboundBytesBefore;

  public PublicMetadataHpackProfiler() {
  ...
  public String getDescription() {
    return "Process CPU time and modeled outbound HTTP/2 bytes per HPACK operation";
  }

  @Override
  public void beforeIteration(BenchmarkParams benchmarkParams, IterationParams iterationParams) {
    cpuTimeBefore = operatingSystem.getProcessCpuTime();
    outboundBytesBefore = PublicMetadataHpackBenchmark.http2OutboundBytes();
  }
  ...
  public Collection<? extends Result> afterIteration(
    ...
    long outboundBytes = PublicMetadataHpackBenchmark.http2OutboundBytes() - outboundBytesBefore;
    return Arrays.asList(
        new ScalarResult(
            "processCpu",
        ...
        new ScalarResult(
            "modeledHttp2OutboundBytes",
            outboundBytes / (double) operations,
            "bytes/op",
            AggregationPolicy.AVG));
  }
}
